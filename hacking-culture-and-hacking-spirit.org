...
parts dealing with the MIT hackers (60s mostly), West Coast hardware
hackers (70s), and game hackers (80s). Perhaps too exalted at times,
...
The sound of a tree falling when there's nobody there to hear it. An
ancient operating system designed and put together by the MIT
hackers. Originated on the PDP-6, later transplanted to
PDP-10. Birthplace of MacLisp, Scheme, Planner, Conniver, Emacs and
many more. Featured extensively in [[https://www.amazon.com/Hackers-Computer-Revolution-Steven-Levy/dp/1449388396][Levy's book]]. Today it is but a
memory. Or is it?
